...
{
   // Supporting Classes
   private NotesEditorRenderer renderer;
   private NotesEditorFunctions functions;

   // User defined individualized settings object (public static for accessibility)
   public static NotesSettings CachedSettings { get; private set; }

   // Editor window properties (public for accessibility by other classes)
   public Vector2 ScrollPosition { get; private set; }
   public string[] NotesCollectionPaths { get; private set; }
   public int SelectedNotesCollectionIndex { get; set; }
   public string[] ScriptFilePaths { get; private set; }
   ...
   private void FetchNotesCollectionPaths()
   {
